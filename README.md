...
# Usage:
    ...
    The PolitiCandid app is useful for anyone that is unsure if a particular candidate matches the same issues that the voter has. Allowing the voter to make informed decisions about their vote. 
